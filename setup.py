...
DESCRIPTION = 'Localized Clustering and Alternatives (LCA) - An algorithm for curating a graph of animal sightings'
KEYWORDS = [
    'wildbook',
    'wildme',
    'ibeis',
...
KWARGS = OrderedDict(
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/WildbookOrg/wbia-plugin-lca/issues',
